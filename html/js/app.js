...
function updateweights($fromSlot, $toSlot, $fromInv, $toInv, $toAmount) {
    ...
    if (
        ($fromInv.attr("data-inventory") == "hotbar" && $toInv.attr("data-inventory") == "player") ||
    ...
    if (
        ($fromInv.attr("data-inventory").split("-")[0] == "itemshop" && $toInv.attr("data-inventory").split("-")[0] == "itemshop") ||
    ...
    $("#player-inv-weight").html("⚖️: " + (parseInt(totalWeight) / 1000).toFixed(2) + " / " + (playerMaxWeight / 1000).toFixed(2));
    if (
        $fromInv.attr("data-inventory").split("-")[0] != "itemshop" &&
        ...
        $("#other-inv-weight").html("⚖️: " + (parseInt(totalWeightOther) / 1000).toFixed(2) + " / " + (otherMaxWeight / 1000).toFixed(2));
    }
...
(() => {
    ...
    Inventory.Open = function (data) {
        ...
        $("#player-inv-weight").html("⚖️: " + (totalWeight / 1000).toFixed(2) + " / " + (data.maxweight / 1000).toFixed(2));
        ...
        if (data.other != null) {
            ...
            if (name != null && (name.split("-")[0] == "itemshop" || name == "crafting")) {
                ...
                $("#other-inv-label").html(data.other.label);
                $("#other-inv-weight").html("⚖️: " + (totalWeightOther / 1000).toFixed(2) + " / " + (data.other.maxweight / 1000).toFixed(2));
            }
            otherMaxWeight = data.other.maxweight;
            otherLabel = data.other.label;
        } else {
            $("#other-inv-label").html(Inventory.droplabel);
            $("#other-inv-weight").html("⚖️: " + (totalWeightOther / 1000).toFixed(2) + " / " + (Inventory.dropmaxweight / 1000).toFixed(2));
