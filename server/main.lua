...
local function AddItem(source, item, amount, slot, info)
	...
	if itemInfo['type'] == 'weapon' then
		info.serie = info.serie or ("Weapon" .. ":" .. QBCore.Shared.RandomInt(3))
		...
		if QBCore.Shared.SplitStr(shopType, "_")[1] == "Dealer" then
			if QBCore.Shared.SplitStr(itemData.name, "_")[1] == "weapon" then
				...
				if Player.Functions.RemoveMoney("cash", price, "dealer-item-bought") then
					itemData.info.serie = ("Weapon" .. ":" .. QBCore.Shared.RandomInt(3))
	...
	if Player then
			if itemData then
				...
				elseif itemData["type"] == "weapon" then
					amount = 1
					info.serie = ("Weapon" .. ":" .. QBCore.Shared.RandomInt(3))
					info.quality = 100
